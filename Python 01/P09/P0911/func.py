...
def readStu():
    global s_no
    with open("C:/Workspace_yw/Python/aix_python_0826/학생성적프로그램_박예원/stu3.txt", "r", encoding="utf-8") as f1:
        while True:
            line1 = f1.readline()
            line1 = line1.strip()
            if not line1 : break
...
def wrtStu():
    with open("C:/Workspace_yw/Python/aix_python_0826/학생성적프로그램_박예원/stu3.txt", "w", encoding="utf-8") as f1:
        while True:
            for s in stus.slist:
                str = s.s_str()
                f1.write(str + "\n")

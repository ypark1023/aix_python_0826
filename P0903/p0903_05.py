...
while True :
    ...
    if choice == 1 :
        ...
        if no1 == 1 :
            print("컴퓨터 구매 완료")
            my_info["money"] = my_info["money"]-prod[0]["price"]
            my_info["bonusP"] = my_info["bonusP"]+prod[0]["bonusP"]
        ...
        if no1 == 1 :
            print("냉장고 구매 완료")
            my_info["money"] = my_info["money"]-prod[1]["price"]
            my_info["bonusP"] = my_info["bonusP"]+prod[1]["bonusP"]
            print("남은 금액: {}원".format(my_info["money"]))
            print("보너스 포인트: {}p".format(my_info["bonusP"]))
        elif no1 == 0 :
            print("구매 취소")
        ...
        if no1 == 1 :
            print("오디오 구매 완료")
            my_info["money"] = my_info["money"]-prod[2]["price"]
            my_info["bonusP"] = my_info["bonusP"]+prod[2]["bonusP"]
            print("남은 금액: {}원".format(my_info["money"]))
            print("보너스 포인트: {}p".format(my_info["bonusP"]))
        elif no1 == 0 :
            print("구매 취소")
